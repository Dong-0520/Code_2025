...
import Pkg
Pkg.activate(joinpath(ENV["HOME"], "Code_2025","Space_time_project","julia","MadNLP_env"))
...
# @save joinpath(@__DIR__, "Euler_optimization_result_nonalign_12ele_sbatch.jld2") buffer final_simple_grid final_U 
