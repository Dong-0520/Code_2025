"""
这个文件里大概地尝试了一下optimization 的方法来求解 space_time 问题
并大概总结了什么样的lin—solver 是适合的
并给了一个初步的如何建立optimization model并求解的example
"""
...
plot_u_interactive(grid, [reshape(num_u, size(U0_for_solver))])

plot_u_interactive(grid, [U0_for_solver, reshape(num_u, size(U0_for_solver))])
...
mutable struct SpaceTimeBuffer
    ...
    index_mesh::Int                      # 网格坐标的索引
    index_moving_coordinates::Array{Int64, 1} # 可移动坐标的索引
