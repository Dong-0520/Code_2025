...
# gif(observe_iteration(grid, all_U4[260:1:280, :, :], zlimit, show_true_sol = false), joinpath(@__DIR__, "numerical_test_discts.gif"), fps=2)
...
@save joinpath(@__DIR__, "numerical_sol/numerical_solutions_mesh4_order3.jld2") grid u1 u2 u3 u4 L2_error
...
# order 4 mesh 9 -> L2_error = 0.005839954573884054
# order 4 mesh 10 -> L2_error = 0.005839954573883938
