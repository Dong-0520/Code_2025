...
@save joinpath(@__DIR__, "mesh/BurgersMeshSlab_001_test6_NoVertice.jld2") grid
# @load joinpath(@__DIR__, "mesh/BurgersMeshSlab_001_test6_NoVertice.jld2") grid
...
@time all_U2, diffs2 = space_time_solve(u1, p2, pseudo_dt = 0.0005, num_of_pseudo_time_step = 10000, diss = true, test = true)
